      ...
      <div className="home-container1">
        <header data-thq="thq-navbar" className="home-navbar-interactive">
          <div className="home-container2">
            <img
              alt="logo"
              src="/transparent%20logo1x-1500w.png"
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-text06">Instagram</span>
              <span className="home-text07">Linkedin</span>
            </nav>
        ...
        <h1 className="home-text13">ALEX VETRICK</h1>
        <div className="home-container3">
          <span className="home-text14">Designer</span>
          <span className="home-text15">Photographer</span>
          <div className="home-container4">
            <span className="home-text16">Developer</span>
